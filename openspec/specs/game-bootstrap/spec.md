# game-bootstrap Specification

## Purpose
uni-app Vue3 CLI 工程初始化（支持 H5/微信小程序/App 三端构建）与后端 Nuxt3/Nitro 骨架及 AI 模型配置（vendor 前缀 modelId）。是整个 game-web + server 双子项目工程的地基与构建约定。
## Requirements
...
AND 浏览器打开首页 `pages/index/index.vue` 显示「金田：1851」标题
